...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'add') {
    ...
    $sql = "INSERT INTO herramientas (nombre, descripcion, cantidad) VALUES ('$nombre', '$descripcion', '$cantidad')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'edit') {
    ...
    $sql = "UPDATE herramientas SET cantidad='$cantidad' WHERE id_herramienta='$id_herramienta'";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                                <form method='POST' action='' style='display:inline-block;'>
                                    <input type='hidden' name='id_herramienta' value='" . $row["id_herramienta"] . "'>
                        ...
                        if ($cantidad == 0) {
                            echo "<tr><td colspan='4' style='color: red; font-weight: bold; text-align: center;'>¡Atención! La herramienta '" . $row["nombre"] . "' necesita reabastecimiento.</td></tr>";
                        }
                    }
                } else {
