...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'add') {
    ...
    $sql = "INSERT INTO equipos_electronicos (nombre, descripcion, cantidad) VALUES ('$nombre', '$descripcion', '$cantidad')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'edit') {
    ...
    $cantidad = $_POST['cantidad'];
    $sql = "UPDATE equipos_electronicos SET cantidad='$cantidad' WHERE id_equipo='$id_equipo'";
    if ($conn->query($sql) === TRUE) {
...
$sql = "SELECT * FROM equipos_electronicos";
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        // Agregar clase 'low-stock' si cantidad es 0
                        $cantidad_class = $cantidad == 0 ? "low-stock" : "";
                        ...
                        // Mostrar mensaje de notificación si cantidad es 0
                        if ($cantidad == 0) {
                            echo "<tr><td colspan='5' style='color: red; font-weight: bold; text-align: center;'>¡Atención! El producto '" . $row["nombre"] . "' necesita reabastecimiento.</td></tr>";
                        }
                    }
                } else {
