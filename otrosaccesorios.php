...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'add') {
    ...
    $sql = "INSERT INTO otros_accesorios (nombre, descripcion, cantidad) VALUES ('$nombre', '$descripcion', '$cantidad')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'edit') {
    ...
    $sql = "UPDATE otros_accesorios SET cantidad='$cantidad' WHERE id_accesorio='$id_accesorio'";
...
$sql = "SELECT * FROM otros_accesorios";
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        if ($cantidad == 0) {
                            echo "<tr><td colspan='4' class='notification'>¡Atención! El accesorio '" . $row["nombre"] . "' necesita reabastecimiento.</td></tr>";
                        }
                    }
                } else {
